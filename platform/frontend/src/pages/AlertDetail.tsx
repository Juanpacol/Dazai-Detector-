            ...
            <div>
              ...
              {tierCalibration && tierCalibration.reviewed > 0 ? (
                <p className="mt-1 text-xs text-slate-500">
                  {alert.risk_tier} alerts have been confirmed fraud in{" "}
                  {tierCalibration.observed_precision?.toFixed(0)}% of {tierCalibration.reviewed} reviewed cases.
                </p>
              ) : (
          ...
          {alert.provenance?.source && (
            <div className="mt-4 flex flex-wrap gap-2 text-xs text-slate-500">
              <span className="pill bg-white/[0.03] text-slate-400 ring-white/[0.06]">
                source: {alert.provenance.source}
              </span>
              ...
              >
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  {citation.value !== undefined && (
                    <span className="text-slate-500">value: {String(citation.value)}</span>
                  )}
                </div>
